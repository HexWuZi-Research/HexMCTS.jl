...
class Game:
    ...
    def quit(self):
        if self.gameover:
            return
        return req.get(f"{url}/kill?id={self.id}")
    ...
    while True:
        ...
        for i in range(len(game.board)):
            for j in range(len(game.board)):
                if game.board[i][j] == 1:
                    pygame.draw.circle(screen, "#000000",
                                       all_verts[11*i+j], 18, 0)
                    pygame.draw.circle(screen, "#808080",
                                       all_verts[11*i+j], 18, 1)
                if game.board[i][j] == -1:
        ...
        if validflag:
            ...
            for i in range(len(game.board)):
                for j in range(len(game.board)):
                    if game.board[i][j] == 1:
                        pygame.draw.circle(
                            screen, "#000000", all_verts[11*i+j], 18, 0)
                        pygame.draw.circle(
                            screen, "#808080", all_verts[11*i+j], 18, 1)
                    if game.board[i][j] == -1:
                        pygame.draw.circle(
                            screen, "#FFFFFF", all_verts[11*i+j], 18, 0)
                        pygame.draw.circle(
                            screen, "#808080", all_verts[11*i+j], 18, 1)
            pygame.display.update()
...
parser.add_argument('-w', '--you_are_white',
                    action='store_true')
